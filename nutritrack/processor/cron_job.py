...
def cron_job_weekly_stats(db_name):
    try:
        ...
        # Start and end dates of the past week (Sunday to Saturday)
        today = datetime.now()
        ...
        # Users fetch from the Users table
        ...
        for user in users:
            ...
            # Values' aggregation for the past week from the Konsumiert table
            cursor.execute('''
                SELECT 
            ...
            for user in users:
                ...
                # Weekly summary transport into the Weekly_Stats table
                cursor.execute('''
                    SELECT 
                        SUM(p.calories * k.amount) AS total_calories,
                        SUM(p.protein * k.amount) AS total_protein,
